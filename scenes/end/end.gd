...
const _SEQUENCE = [
	...
	{"bg": Color(0.7, 0.0, 0.0, 1),  "text": "YOU DID THIS.",           "fg": Color(1, 1, 1, 1),   "hold": 1.8},
	{"bg": Color(0, 0, 0, 1),        "text": "",                        "fg": Color(0, 0, 0, 1),   "hold": 0.6},
	{"bg": Color(0.0, 0.0, 0.6, 1),  "text": "YOU KNEW.",               "fg": Color(1, 1, 1, 1),   "hold": 1.8},
	{"bg": Color(0, 0, 0, 1),        "text": "",                        "fg": Color(0, 0, 0, 1),   "hold": 0.6},
	{"bg": Color(1, 1, 1, 1),        "text": "YOU DIDN'T KNOW.",        "fg": Color(0, 0, 0, 1),   "hold": 1.8},
	{"bg": Color(0, 0, 0, 1),        "text": "",                        "fg": Color(0, 0, 0, 1),   "hold": 0.6},
	{"bg": Color(0.45, 0.0, 0.5, 1), "text": "WAS IT WORTH IT?",        "fg": Color(1, 1, 1, 1),   "hold": 2.5},
	{"bg": Color(0, 0, 0, 1),        "text": "",                        "fg": Color(0, 0, 0, 1),   "hold": 1.2},
	{"bg": Color(0.0, 0.4, 0.0, 1),  "text": "ACCOUNT PAID IN FULL.",   "fg": Color(1, 1, 1, 1),   "hold": 2.5},
